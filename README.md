...
docs/assets/nomad-twin-towers-film-2026-08.mp4  client film, 5:51 and 20 MB, and
docs/assets/nomad-twin-towers-brochure-2026-08.pdf  the client's brochure,
                     6.1 MB and 14 pages. The only two large files on the site,
                     and neither is on the critical path: the film is
                     preload="none" behind a poster, the brochure only moves on
                     a download click. See brief.md before changing that.
