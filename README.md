...
docs/assets/nomad-twin-towers-film.mp4  client film, 21.6 MB, and
docs/assets/nomad-twin-towers-brochure-2026-08.pdf  the client's brochure,
                     ...
                     The date in the filename is load-bearing — /assets/* is
                     cached a week, so a NEW brochure needs a NEW name or edges
                     that already hold the old one keep serving it
