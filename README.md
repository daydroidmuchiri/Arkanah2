...
docs/assets/nomad-twin-towers-brochure.pdf  the client's brochure, 6.1 MB and
                     14 pages (2026-08-01). The only two large files on the
                     site, and neither is on the critical path: the film is
